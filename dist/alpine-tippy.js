(() => {
  ...
  function src_default(Alpine) {
    Alpine.directive("tippy", (el, { modifiers, expression }, { effect: effect5, evaluateLater, cleanup }) => {
      ...
      effect5(() => {
        evaluator((evaluated) => {
          ...
          if ((props.allowHTML || instance?.allowHTML && props.allowHTML === void 0) && _D) {
            props.content = modifiers.includes("raw") ? props.content : _D.safe(props.content ?? instance.content);
          }
          if (instance && contentOnly) {
            ...
            instance = tippy_esm_default(el, props);
          }
        });
      });
      cleanup(() => {
    ...
    if (!window.tippy) {
      ...
      document.dispatchEvent(new CustomEvent("tippy:init", { bubbles: true, composed: true, cancelable: true }));
    }
  }
...
//# sourceMappingURL=alpine-tippy.js.map
